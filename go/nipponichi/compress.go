...
func (c *Compress) Encode2(src []byte) ([]byte, error) {
	// not the algorithm that the game uses, but
	// simplest encoding that gets through the decoder
...
func (c *Compress) copy(dst, src []byte, dp, sp, n uint32) error {
...
func (c *Compress) Decode2(src []byte, limit uint32) ([]byte, error) {
