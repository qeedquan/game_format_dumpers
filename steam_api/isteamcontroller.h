...
S_CLASSAPI bool S_CLASSCALLTYPE SteamController_GetControllerState(uint32_t index, void *state);
S_CLASSAPI void S_CLASSCALLTYPE SteamController_SetOverrideMode(const char *pchMode);
S_CLASSAPI void S_CLASSCALLTYPE SteamController_TriggerHapticPulse(ControllerHandle_t controllerHandle, ESteamControllerPad eTargetPad, unsigned short usDurationMicroSec);