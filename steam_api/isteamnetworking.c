...
SteamAPI_ISteamNetworking_CreateListenSocket(SELF, int nVirtualP2PPort, uint32 nIP, uint16 nPort, bool bAllowUseOfPacketRelay)
{
...
S_CLASSAPI SNetSocket_t S_CLASSCALLTYPE
SteamAPI_ISteamNetworking_CreateConnectionSocket(SELF, uint32 nIP, uint16 nPort, int nTimeoutSec)
{
...
S_CLASSAPI bool S_CLASSCALLTYPE
SteamAPI_ISteamNetworking_GetSocketInfo(SELF, SNetSocket_t hSocket, CSteamID *pSteamIDRemote, int *peSocketStatus, uint32 *punIPRemote, uint16 *punPortRemote)
{
...
S_CLASSAPI bool S_CLASSCALLTYPE
SteamAPI_ISteamNetworking_GetListenSocketInfo(SELF, SNetListenSocket_t hListenSocket, uint32 *pnIP, uint16 *pnPort)
{
