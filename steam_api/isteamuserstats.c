...
SteamAPI_ISteamUserStats_GetStat(SELF, const char *pchName, int32 *pData)
{
...
S_CLASSAPI bool S_CLASSCALLTYPE
SteamAPI_ISteamUserStats_GetStat0(SELF, const char *pchName, float *pData)
{
	xlogf("%s(self = %p, pchName = %s, pData = %p)\n", __func__, self, pchName, pData);
	return true;
}
...
S_CLASSAPI bool S_CLASSCALLTYPE
SteamAPI_ISteamUserStats_SetStat(SELF, const char *pchName, int32 nData)
{
...
S_CLASSAPI bool S_CLASSCALLTYPE
SteamAPI_ISteamUserStats_SetStat0(SELF, const char *pchName, float nData)
{
...
S_CLASSAPI bool S_CLASSCALLTYPE
SteamAPI_ISteamUserStats_GetGlobalStat0(SELF, const char *pchStatName, float *pData)
{
	xlogf("%s(self = %p, pchStatName = %s, pData = %p)\n", __func__, self, pchStatName, pData);
	return true;
}
...
S_CLASSAPI int32 S_CLASSCALLTYPE
SteamAPI_ISteamUserStats_GetGlobalStatHistory0(SELF, const char *pchStatName, float *pData, uint32 cubData)
{
	xlogf("%s(self = %p, pchStatName = %s, pData = %p, cubData = %d)\n", __func__, self, pchStatName, pData, cubData);
	return 0;
}
