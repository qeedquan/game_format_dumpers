...
extern VtableEntry vtable_ISteamUtils[5];
extern VtableEntry vtable_ISteamUser[6];
extern VtableEntry vtable_ISteamUserStats[3];
extern VtableEntry vtable_ISteamInventory[3];
...
extern VtableEntry vtable_ISteamUGC[3];
extern VtableEntry vtable_ISteamHTMLSurface[4];
