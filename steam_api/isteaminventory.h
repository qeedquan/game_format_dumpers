...
S_CLASSAPI bool S_CLASSCALLTYPE SteamAPI_ISteamInventory_SetPropertyInt(SELF, SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, int64 nValue);
