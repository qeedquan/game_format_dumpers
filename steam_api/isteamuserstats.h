...
S_CLASSAPI bool S_CLASSCALLTYPE SteamAPI_ISteamUserStats_GetStat(SELF, const char *pchName, int32 *pData);
S_CLASSAPI bool S_CLASSCALLTYPE SteamAPI_ISteamUserStats_GetStat0(SELF, const char *pchName, float *pData);
S_CLASSAPI bool S_CLASSCALLTYPE SteamAPI_ISteamUserStats_SetStat(SELF, const char *pchName, int32 nData);
S_CLASSAPI bool S_CLASSCALLTYPE SteamAPI_ISteamUserStats_SetStat0(SELF, const char *pchName, float nData);
